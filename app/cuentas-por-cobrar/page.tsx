            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>{t("tabla.total")}</th>
                  <th>{t("cuentas_por_cobrar.vence")}</th>
              ...
              <tbody>
                {deuda.ventas.map((venta) => {
                  const vencida =
                    ...
                    new Date(venta.fecha_vencimiento) < new Date();
                  ...
                  return (
                    <tr key={venta.id}>
                      ...
                      <td style={vencida ? { color: "var(--color-peligro, #dc2626)", fontWeight: 600 } : undefined}>
                        {venta.fecha_vencimiento
                          ? new Date(venta.fecha_vencimiento).toLocaleDateString()
                          : "\u2014"}
                        {vencida && ` (${t("cuentas_por_cobrar.vencida")})`}
                      </td>
                      <td>
                        {puedeCobrar ? (
                          <button
